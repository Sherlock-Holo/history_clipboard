//! the ListFilter is reference to
//! https://github.com/linebender/druid-widget-nursery/blob/master/src/list_filter.rs, however use
//! that crate need to specify the commit for druid, it's not a good idea for me
